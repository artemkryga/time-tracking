package ua.kryha.service.security.provider;
...
import ua.kryha.service.security.token.TokenAuthentication;
...
public class TokenAuthenticationProvider implements AuthenticationProvider{
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (tokenCandidate.isPresent()) {
          UserDetails userDetails = userDetailsService.loadUserByUsername(tokenCandidate.get().getJUser().getLogin());
